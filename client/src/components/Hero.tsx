...
export default function Hero() {
  ...
  return (
    <div id="hero" className="relative min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden pt-24 pb-20">
      {/* 3D Galaxy */}
      ...
      <div
        ...
        className="relative z-10 flex flex-col items-center justify-center text-center px-4 w-full mt-8 sm:mt-0"
      >
      ...
      <motion.button
        ...
        className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-gray-400 hover:text-[#00E5FF] transition-colors z-10"
      >
